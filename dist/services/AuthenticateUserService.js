...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var usersReposisoty, user, passwordMatched, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        usersReposisoty = typeorm_1.getRepository(User_1.default);
                        return [4 /*yield*/, usersReposisoty.findOne({
                                where: { email: email },
                            })];
                    case 1:
                        user = _b.sent();
                    ...
                    case 2:
                        ...
                        token = jsonwebtoken_1.sign({}, 'b2e9d04fe95e37c6d2189a4c21c93c3a', {
                            subject: user.id,
                            expiresIn: '1d',
                        });
                        return [2 /*return*/, {
